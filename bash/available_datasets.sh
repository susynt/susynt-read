...
dq2-ls group.phys:group.phys.mc15_13TeV.*.SusyNt.*${thisTag}_nt/ 2>&1 |tee ${mcOut}
echo "dq2-ls user.dantrim:user.dantrim.mc15_13TeV.*.SusyNt.*${thisTag}_nt/"
dq2-ls user.dantrim:user.dantrim.mc15_13TeV.*.SusyNt.*${thisTag}_nt/ 2>&1 |tee --append ${mcOut}

echo ""
echo "Loking for data15"
echo "dq2-ls group.phys:group.phys.data15_13TeV.*.SusyNt.*${thisTag}_nt/"
dq2-ls group.phys:group.phys.data15_13TeV.*.SusyNt.*${thisTag}_nt/ 2>&1 |tee ${dataOut}
echo "dq2-ls user.dantrim:user.dantrim.data15_13TeV.*.SusyNt.*${thisTag}_nt/"
dq2-ls user.dantrim:user.dantrim.data15_13TeV.*.SusyNt.*${thisTag}_nt/ 2>&1 |tee --append ${dataOut}
